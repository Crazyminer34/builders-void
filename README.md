...
> [!IMPORTANT]
> The mod is currently not well-suited for multiplayer as all players teleport to the same location in the void dimension. This will be changed in a future version.
