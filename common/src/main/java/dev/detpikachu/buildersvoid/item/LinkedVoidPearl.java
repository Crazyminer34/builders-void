...
import dev.detpikachu.buildersvoid.data.UserIdentifier;
...
public class LinkedVoidPearl extends VoidPearl {
    ...
    public void appendHoverText(ItemStack stack, TooltipContext context, List<Component> tooltipComponents, TooltipFlag tooltipFlag) {
        ...
        tooltipComponents.add(ComponentLogic.formatted("tooltip.buildersvoid.linked_void_pearl.usage.bound", userIdentifier.name()));
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand usedHand) {
        ...
        addCooldown(player);
        player.displayClientMessage(ComponentLogic.formatted("message.buildersvoid.linked_void_pearl.teleport", userIdentifier.name()), true);
        return InteractionResultHolder.pass(itemStack);
    }
}
