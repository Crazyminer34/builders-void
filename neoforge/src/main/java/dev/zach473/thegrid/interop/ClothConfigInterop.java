...
public class ClothConfigInterop implements IConfigScreenFactory {
    @Override
    ...
    public static Screen getConfigScreen(Screen parentScreen) {
            final var builder = ConfigBuilder.create()
                ...
                .setTitle(Component.translatable(ConfigLocalization.forTitle(ModConstants.MOD_ID)));
            final var schemas = Balm.getConfig().getSchemasByNamespace(ModConstants.MOD_ID);
